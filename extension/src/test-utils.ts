...
export type ContextMock = Context & {
    mocks: {
        ...
        simulateScripts: (adapterScript: ExaScriptsRow | null, importScript: ExaScriptsRow | null) => void
    }
}
