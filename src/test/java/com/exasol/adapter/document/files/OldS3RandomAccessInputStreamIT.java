...
import com.exasol.adapter.document.files.s3testsetup.OldLocalStackS3TestSetup;
...
class OldS3RandomAccessInputStreamIT extends RandomAccessInputStreamTestBase {
    ...
    protected void prepareTestSetup(final byte[] bytes) {
        this.testSetup = new OldLocalStackS3TestSetup();
