...
/**
 * See parent class {@link AbstractRemoteFileContentIT} for actual test cases which are generic for all test setup
 * flavors implementing interface {@code S3ContainerSetup}.
 */
@Tag("integration")
public class RemoteFileContentMinioIT extends AbstractRemoteFileContentIT {
